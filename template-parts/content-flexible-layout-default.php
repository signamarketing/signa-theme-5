              ...
              if( have_rows('row') ):
                while( have_rows('row') ): the_row();
                  if( get_row_index() % 2 == 0 ){
                    // this is an even row aka the SECOND ROW
              ?>
                  <div class="row">
