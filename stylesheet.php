          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-12 col-lg-4 p-0 mb-3">
                <button class="btn sharp dark-blue">sharp button</button>
              </div>
              <div class="col-12 col-lg-4 p-0 mb-3">
                <button class="btn pill dark-blue circular">pill button</button>
              </div>
              <div class="col-12 col-lg-4 p-0 mb-3">
